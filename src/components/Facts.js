...
const st = {'width': '60px', 'height': '60px'};
const Facts = ()=>{
    return(
        <div className="container-fluid bg-primary facts py-5">
        <div className="container py-5">
            <div className="row gx-5 gy-4">
                <div className="col-lg-3 col-md-6">
                    <div className="d-flex">
                        <div className="bg-secondary rounded-circle d-flex align-items-center justify-content-center mb-3" style={st}>
